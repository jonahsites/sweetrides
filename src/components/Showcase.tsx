...
const sections = [
  {
    label: "01 — Sweet Ride",
    title: "Lamborghini\nUrus SE",
    desc: "Turn heads everywhere you go. The Urus SE blends raw SUV power with supercar soul — the ultimate Sweet Ride.",
    tags: ["Super SUV", "Hybrid Power", "Premium Interior"],
    color: "#080C07",
    accent: "#6DC135"
  },
  {
    label: "02 — Ride Sweet",
    title: "BMW\nM4 Competition",
    desc: "Pure performance meets daily driveability. The M4 Competition is a masterclass in fun behind the wheel.",
    tags: ["Grand Tourer", "S58 Inline-6", "High Performance"],
    color: "#080C07",
    accent: "#6DC135"
  },
  {
    label: "03 — Feel the Rush",
    title: "McLaren\n570S Coupe",
    desc: "Carbon-light and lightning-fast. The McLaren 570S is the sweetest way to experience open-road freedom.",
    tags: ["Carbon Monocell", "Mid-Engine", "Track Ready"],
    color: "#080C07",
    accent: "#6DC135"
  }
];
      ...
      <div className="fixed top-24 right-8 z-100 pointer-events-auto">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all ${
            isEditMode
              ? 'bg-accent text-luxury-black shadow-[0_0_20px_rgba(109,193,53,0.4)]'
